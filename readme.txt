...
Reasons to try Fansub Page Manager:
...
1. Upload `wp-fansub_page_manager` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Create a Page for Projects and place `<!--fansubs-->` in the content
