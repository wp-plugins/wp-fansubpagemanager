...
if ( $_POST['addnew'] ) {
	...
	$update = 1;
	$updatemsg = "Release added with success.";
}
if ( $_GET['do'] == "del" ) {
	...
	$update = 1;
	$updatemsg = "Release deleted with success.";
}
if ( $_POST['edit'] == "complete" ) {
	...
	$update = 1;
	$updatemsg = "Release updated with success.";
}
if ( $_GET['do'] == "edit" && !$_POST ) {
?>
<div class="wrap">
	<h2><?php _e('WP-FansubPageManager - Edit', 'wpfansubpagemanager' ); ?></h2>
<?php
...
<table class="widefat post fixed" cellspacing="0">
	<thead>
	<tr>
	<th scope="col" id="title" class="manage-column column-title" colspan="2">Edit Release</td>
	</tr>
	</thead>
	<tbody>
		...
		<tr id='addnew' class='author-other status-publish iedit' valign="top"><td style='width:100px;'>Project:</td><td class="post-title column-title"><select name='pid'>
<?php
...
?>
		...
		<tr id='addnew' class='author-other status-publish iedit' valign="top"><td style='width:100px;'>Episode:</td><td class="post-title column-title"><input type='text' name='epi' style='width:400px;' value='<?php echo(stripslashes($row['epi'])); ?>' /></td></tr>
		<tr id='addnew' class='author-other status-publish iedit' valign="top"><td style='width:100px;'>Version:</td><td class="post-title column-title"><input type='text' name='ver' style='width:400px;' value='<?php echo(stripslashes($row['ver'])); ?>' /></td></tr>
...
?>
<div class="wrap">
	<h2><?php _e('WP-FansubPageManager - Releases', 'wpfansubpagemanager' ); ?></h2>
<?php
if ( $error ) {
?>
...
<table class="widefat post fixed" cellspacing="0">
	...
	<th scope="col" id="episode" class="manage-column column-author" style="">Episode</th>
	<th scope="col" id="crc32" class="manage-column column-categories" style="">CRC32</th>
	<th scope="col" id="date" class="manage-column column-categories" style="">Added</th>
...
?>
	<tr id='proj-<?php echo($r['id']); ?>' class='<?php echo(($i%2) ? "" : "alternate "); ?>author-other status-publish iedit' valign="top">
		...
		<td class="post-title column-title"><strong><a class="row-title" href="#"><?php echo(stripslashes($r['title'])); ?></a></strong>
			<div class="row-actions"><span class='edit'><a href="admin.php?page=<?php echo(FNSB_DIRNAME); ?>/releases.php&do=edit&editid=<?php echo($r['rid']); ?>" title="Edit this release">Edit</a> | </span><span class='delete'><a class='submitdelete' title='Delete this release' href='admin.php?page=<?php echo(FNSB_DIRNAME); ?>/releases.php&do=del&delid=<?php echo($r['rid']); ?>' onclick="if ( confirm('You are about to delete this project \'<?php echo($wpdb->escape($r['title'])); ?>\' episode \'<?php echo($r['epi'].($r['ver'] !== "1" ? "v".$r['ver'] : "")); ?>\'.\n \'Cancel\' to stop, \'OK\' to delete.') ) { return true;}return false;">Delete</a></div>
		</td>
...
<table class="widefat post fixed" cellspacing="0">
	<thead>
	<tr>
	<th scope="col" id="title" class="manage-column column-title" colspan="2">Add New Release</td>
	</tr>
	</thead>
	<tbody>
...
?>
		...
		<tr id='addnew' class='author-other status-publish iedit' valign="top"><td style='width:100px;'>Episode:</td><td class="post-title column-title"><input type='text' name='epi' style='width:400px;' /></td></tr>
		<tr id='addnew' class='author-other status-publish iedit' valign="top"><td style='width:100px;'>Version:</td><td class="post-title column-title"><input type='text' name='ver' style='width:400px;' /></td></tr>
